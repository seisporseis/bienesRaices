...
?>
    ...
    <main class="contenedor seccion">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio4.wepb" type="image/wepb">
                    <source srcset="build/img/anuncio4.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/anuncio4.jpg" alt="foto de anuncio">
                </picture>
            ...
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio5.wepb" type="image/wepb">
                    <source srcset="build/img/anuncio5.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/anuncio5.jpg" alt="foto de anuncio">
                </picture>
            ...
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio6.wepb" type="image/wepb">
                    <source srcset="build/img/anuncio6.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/anuncio6.jpg" alt="foto de anuncio">
                </picture>
